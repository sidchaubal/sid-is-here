...
var PANEL_ANIMATION_STEPS = 10;
	...
	document.getElementById(theid).style.visibility = 'collapse'; 
	...
	//alert('do the thing'+' id '+document.getElementById(theid).id);
   
	if(document.getElementById(theid).id!='HMD')
        hideDiv('HMD');
    if(document.getElementById(theid).id!='HIMYM')
        hideDiv('HIMYM');
    if(!(document.getElementById(theid).id=="vid"))
    { hideDiv('vid'); }
